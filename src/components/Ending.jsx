  ...
  return (
    <section className="min-h-screen bg-[url('https://themewant.com/products/wordpress/landing/almaris/demo-wp/bg-2.webp')] flex items-center justify-center relative bg-cover">
      <div className="text-center max-w-[1000px] mx-auto px-[12px]">
        ...
        <h1
          className="mb-[20px] text-white font-marcellus text-[48px] md:text-[60px] lg:text-[64px] leading-[1.2]"
          data-aos="fade-up"
          data-aos-delay="200"
          data-aos-easing="ease-out"
        >
        ...
        <p
          className="font-jost text-[17px] font-light text-[#c3c3c3] mb-[20px]"
          data-aos="fade-up"
          data-aos-delay="300"
          data-aos-easing="ease-out"
        >
      ...
      <div className="absolute bottom-0 h-[30%] w-full bg-gradient-to-t from-[#ab8965]/80 from-25% to-transparent z-1"></div>
    </section>
  );
};
